...
function ThirdSection() {
    return (
        <Container sx={{ mt: 4 }} >
            ...
            <Container maxWidth="lg" sx={{ display: 'flex' }} className='col-6'>
            {/* className='d-flex flex-wrap cols-6' */}
            {/* sx={{ display: 'flex' }}  */}
                <Box maxWidth='md'>
                ...
                <Box maxWidth='md' sx={{mx:'auto', display: 'flex', flexDirection: 'column' , justifyContent:'space-evenly' }}
                 >
                    <Box>
